...
var gone=false,go=function(){if(gone)return;gone=true;var el=document.getElementById(${JSON.stringify(SPLASH_ID)});if(el)el.remove()};
setTimeout(go,${SPLASH_MS});document.addEventListener("click",go,{once:true});document.addEventListener("keydown",go,{once:true})})()`;
