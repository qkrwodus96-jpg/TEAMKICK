...
export function demoState():State{
 ...
 s.teams=[{id:"team-a",name:"한강 FC",region:"서울 마포구",description:"일요일 아침, 함께 뛰는 즐거움. 매너 있는 축구를 지향하는 한강 FC입니다.",days:"일요일 오전",format:"11인제",level:"중",status:"active",applicant:"demo-a",applicantName:"김지훈",at:iso(next-90*864e5),color:"green"},{id:"team-b",name:"서울 유나이티드",region:"서울 강서구",description:"꾸준하게, 즐겁게 함께 뛰는 팀입니다.",days:"주말",format:"11인제",level:"중",status:"active",applicant:"demo-b",applicantName:"이준호",at:iso(next-60*864e5),color:"orange"},{id:"team-c",name:"분당 FC",region:"경기 성남시",description:"신규 팀 등록을 신청합니다.",status:"pending",applicant:"demo-c",applicantName:"최민수",at:iso(),format:"11인제",color:"blue"}];
 ...
 const g:any={id:"game-"+i,home:"team-a",away:i===0?"team-b":null,external:i===1?"":i===0?"":["","","마포 FC","서강 FC","용산 FC","여의도 FC"][i],start:iso(when),end:iso(when+2*3600e3),venue:i===1?"월드컵공원 축구장":"난지천공원 인조잔디축구장",address:i===1?"서울 마포구 하늘공원로 108":"서울 마포구 월드컵로 365",region:"서울 마포구",format:"11인제",secured:true,cost:100000,status:isPast?"completed":"scheduled",listing:i===1?"open":i===0?"matched":"none",revision:1,result:isPast?{a:i===4?2:3,b:i===4?2:1,status:"confirmed",revision:1}:null};
 ...
 const open={id:"game-other",home:"team-b",away:null,external:"",start:iso(next+864e5),end:iso(next+864e5+2*3600e3),venue:"강서 개화축구장",address:"서울 강서구 방화동 47",region:"서울 강서구",format:"11인제",secured:true,cost:80000,status:"scheduled",listing:"open",revision:1,result:null};s.games.push(open);s.sides.push(newSide(open,"team-b"));
